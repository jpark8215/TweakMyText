/*
  # Fix token system migration - handle existing constraints

  1. Schema Changes
    - Safely rename columns from credit to token terminology
    - Handle existing constraints properly
    - Update token limits for new pricing structure
  ...
  3. Notes
    - This migration safely handles cases where columns/constraints already exist
    - Preserves existing data while updating schema
    - Updates all functions to use token terminology
*/
